    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="body">
                    <div class="contenar">
                        <form action="{{route('destroy', ['id' => $rose->id])}}" method="POST">
                            @csrf
                            @method('DELETE')
                                <div class="start">
                                <center>
                                    <div class="a_1"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <button id="submitButton" type="submit" class="delete"> DELETE</button>
                            </div>
                            </div>
                        </form>
                    </div>
